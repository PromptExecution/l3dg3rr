...
- [ ] **Phase 1: Contracts & Session Bootstrap** - Lock workbook/session contracts and input preflight before ledger mutation.
...
|-------|----------------|--------|-----------|
| 1. Contracts & Session Bootstrap | 0/TBD | Not started | - |
| 2. Deterministic Ingestion Pipeline | 0/TBD | Not started | - |
